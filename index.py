...
with tabs[0]:
    ...
    with st.form("prediction_form"):
        ...
        with col1:
            ...
            pre_bmi = st.number_input("Pre-pregnancy BMI", 10.0, 45.0, 22.0, step=0.1)
            visits = st.slider("Number of Prenatal Visits", 0, 20, 5)
        with col2:
        ...
        with st.spinner("Analyzing data and making prediction..."):
            try:
                input_df = pd.DataFrame({
                    ...
                    'pre_pregnancy_bmi': [pre_bmi],
                    'number_of_prenatal_visits': [visits],
