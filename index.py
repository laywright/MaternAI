# app.py - Enhanced Neonatal Risk Predictor
...
# === 📊 DATA PROCESSING ===
def prepare_input_data(age, systolic, diastolic, hemoglobin, parity, anemia, preeclampsia):
...
def main():
    ...
    if submit:
        with st.spinner("🔍 Analyzing data and making prediction..."):
            try:
                ...
                # Prepare input data
                input_data = prepare_input_data(age, systolic, diastolic, 
                                             hemoglobin, parity, anemia, preeclampsia)
    ...
    <div style="text-align: center;">
        <p>© 2025 MaternAI · Built for SDG 3.1 · <a href="mailto:info@nexusflow.ai">Contact Us</a></p>
